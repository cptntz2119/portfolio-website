...
export const PROJECTS = [
  {
    image: typingDuel,
    name: "Typing Duel",
    technologyUsed: "ReactJS, Javascript, Ruby on Rails, Express, PostgreSQL, Socket.io",
    description: "Typing duel is an Single Page app that allows you to practice typing and optionally compete with other users.",
    url: "https://github.com/cptntz2119/LHL_final_typing_duel",
  },
  {
    image: interviewScheduler,
    name: "interviewScheduler",
    technologyUsed: " React, Express, Webpack, Babel, Axios, WebSockets, PostgreSQL,Storybook, Jest, Testing library",
  ...
  },
  {
    ...
    description: "A web app that allows users to collaboratively create maps which list multiple interested location with google map API",
    url: "https://github.com/cptntz2119/MyMapMarker",
  },
  {
    image: portfolio,
    name: "portfolio",
    technologyUsed: "HTML, CSS, JS, React for front-end , and Node, Express for back-end.",
